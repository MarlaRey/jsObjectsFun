...
myOldEmployees = myEmployees.filter( employee => employee.alder>30 );
console.table(myOldEmployees);



//Opgave 2: brug javascript til at oprette en ny array med alle ansatte under 20 år  log resultatet til konsollen som table

myYoungEmployees = myEmployees.filter( employee => employee.alder<30 );
console.table(myYoungEmployees);
...
myOldFemaleEmployees = myEmployees.filter( employee => employee.alder>30 && employee.køn=='Kvinde' );
console.table(myOldFemaleEmployees);
console.clear();
...
myFunkyEmployees = myEmployees.filter( employee => employee.alder>20 && employee.køn!=='Mand' && employee.køn!=='Kvinde');
console.table(myFunkyEmployees);
